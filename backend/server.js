...
// Middleware
// Remove trailing slash from FRONTEND_URL if present to fix CORS
...
// Routes
const soilTestsRoutes = require('./routes/soilTests');
const soilReportsRoutes = require('./routes/soilReports');
const ordersRoutes = require('./routes/orders');

app.use('/api/auth', authRoutes);
app.use('/api/chat', chatRoutes);
app.use('/api/soil-tests', soilTestsRoutes);
app.use('/api/soil-reports', soilReportsRoutes);
